...
PRED = os.path.join(ROOT, "nnunet_baseline_results", "predictions_run0")
...
with open(os.path.join(OUT, "nnunet_regrid320_per_image.csv"), "w", newline="", encoding="utf-8") as f:
...
for grid, keys in [("native", ["f1_native", "assd_native_px", "hd95_native_px", "bf1_5_native"]),
    ...
    summary.append(m)
with open(os.path.join(OUT, "nnunet_regrid320_summary.csv"), "w", newline="", encoding="utf-8") as f:
